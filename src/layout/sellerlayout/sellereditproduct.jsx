...
function Sellereditproduct() {
  ...
  useEffect(() => {
    async function fetchproduct() {
      ...
      setProductAvailable(data.productAvailable);
      setShortDescription(data.shortDescription);
      setDescription(data.description);
      setOldImage(data.productimage);
    }
          ...
          <div className="bg-white rounded-lg shadow p-4 md:p-6">
            ...
            <form onSubmit={handlesubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4"  >
              ...
              <div>
                ...
                <input type="number" className="border rounded w-full p-2 mt-1" value={stockItem}
                  onChange={(e) => setStockItem(e.target.value)} required
                />
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <input type="text" className="border rounded w-full p-2 mt-1"
              ...
              <div className="sm:col-span-2">
                ...
                <textarea className="border rounded w-full p-2 mt-1" rows="3"
